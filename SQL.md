...
![用户表](https://github.com/zptime/resources/blob/master/images/nuxt-koa-mysql/table-user.png)

- 角色表（role）

![角色表](https://github.com/zptime/resources/blob/master/images/nuxt-koa-mysql/table-role.png)

- 权限表（auth）

![权限表](https://github.com/zptime/resources/blob/master/images/nuxt-koa-mysql/table-auth.png)

- 用户角色表（userRole）

![用户角色表](https://github.com/zptime/resources/blob/master/images/nuxt-koa-mysql/table-user-role.png)

- 角色权限表（roleAuth）

![角色权限表](https://github.com/zptime/resources/blob/master/images/nuxt-koa-mysql/table-role-auth.png)

- 用户登录日志表(loginLog)

![用户登录日志表](https://github.com/zptime/resources/blob/master/images/nuxt-koa-mysql/table-login-log.png)

## 建表语句

```js
// 详见server/db/create.js
// 创建数据表
const createTables = {
  // 用户表
